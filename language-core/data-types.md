...
* containers of containers: the content is shallow copied \(the content of the content is only referenced, not copied\)
...
`myData = readdlm(myinputfile, '\t', Float64)[2:end,4:end]); # skip the first 1 row and the first 3 columns`
